        ...
        <div style={containerStyle}>
            ...
            <div style={scrollingTextStyle}>
                <p style={paragraphStyle}>
                    Every morning you wake up is a fresh opportunity <br />
                    to take control of your life and more closer to <br />
                    your goals. The road ahead won't always be easy <br />
                    but remember that nothing worthwhile comes without <br />
                    effort. Your dreams matter and so do the action <br />
                    you take to achieve them. Success is not about <br />
                    instant results but about persistence and <br />
                    dediction. Even when the progress seems slow <br />
                    keep your vision clear and your heart determind. <br />
                    When you feel tired or discouraged remind yourself <br />
                    why you started. Take one step at a time because <br />
                    even small steps add up to bige changes over time. <br />
                    Surround yourself with positivity. Your mindset <br />
                    is your most powerful tool. Don't be afraid to fail. <br />
                    Each failure is a lesson, a necessary part of growth. <br />
                    You only truly fail when you give up, so keep going <br />
                    keep learning and stay focused. You have within <br />  
                    you the strength, the resilience and the passion <br />
                    to overcome anything that comes your way. <br />
                    stay patient, stay persistent and trust <br />
                    that your hard work will pay off. <br />
